...
export const wordBank = {
  ...
  videojuegos: ['League of legends','Mario','Zelda','Minecraft','Tetris','Pac-Man','Sonic','Kirby','Pikachu','Donkey Kong','Animal Crossing','Splatoon','Rocket League','Stardew Valley','Fall Guys','Rayman','Crash Bandicoot','Spyro','Just Dance','Portal','SimCity','The Sims','Overcooked','Celeste','Hollow Knight','Cuphead','Among Us','FIFA','Gran Turismo','Forza','LittleBigPlanet'],
